...
let ProductLedgerWidgetComponent = class ProductLedgerWidgetComponent {
    constructor() {
        ...
        this.Safequantity = "98Kg";
        this.Damagequantity = "28Kg";
...
ProductLedgerWidgetComponent.propDecorators = {
    ...
    Safequantity: [{ type: _angular_core__WEBPACK_IMPORTED_MODULE_2__.Input }],
    Damagequantity: [{ type: _angular_core__WEBPACK_IMPORTED_MODULE_2__.Input }],
    Suppcode: [{ type: _angular_core__WEBPACK_IMPORTED_MODULE_2__.Input }],
...
SitLedgerWidgetComponent.propDecorators = {
    bakery: [{ type: _angular_core__WEBPACK_IMPORTED_MODULE_2__.Input }],
    itemName: [{ type: _angular_core__WEBPACK_IMPORTED_MODULE_2__.Input }],
    dueDate: [{ type: _angular_core__WEBPACK_IMPORTED_MODULE_2__.Input }],
    suppCode: [{ type: _angular_core__WEBPACK_IMPORTED_MODULE_2__.Input }],
    moveTo: [{ type: _angular_core__WEBPACK_IMPORTED_MODULE_2__.Input }],
    dispatchDate: [{ type: _angular_core__WEBPACK_IMPORTED_MODULE_2__.Input }],
    delivery: [{ type: _angular_core__WEBPACK_IMPORTED_MODULE_2__.Input }],
    expectedDelivery: [{ type: _angular_core__WEBPACK_IMPORTED_MODULE_2__.Input }],
    gateEntryDate: [{ type: _angular_core__WEBPACK_IMPORTED_MODULE_2__.Input }],
    gateEntryNo: [{ type: _angular_core__WEBPACK_IMPORTED_MODULE_2__.Input }],
    mfgLocation: [{ type: _angular_core__WEBPACK_IMPORTED_MODULE_2__.Input }],
    ...
    recPlantDesc: [{ type: _angular_core__WEBPACK_IMPORTED_MODULE_2__.Input }],
    remarks: [{ type: _angular_core__WEBPACK_IMPORTED_MODULE_2__.Input }],
    suppPlant: [{ type: _angular_core__WEBPACK_IMPORTED_MODULE_2__.Input }],
    suppPlantDesc: [{ type: _angular_core__WEBPACK_IMPORTED_MODULE_2__.Input }],
    storageLocation: [{ type: _angular_core__WEBPACK_IMPORTED_MODULE_2__.Input }],
    transName: [{ type: _angular_core__WEBPACK_IMPORTED_MODULE_2__.Input }],
    vehicleNo: [{ type: _angular_core__WEBPACK_IMPORTED_MODULE_2__.Input }]
};
SitLedgerWidgetComponent = (0,tslib__WEBPACK_IMPORTED_MODULE_3__.__decorate)([
    (0,_angular_core__WEBPACK_IMPORTED_MODULE_2__.Component)({
...
WidgetsModule = (0,tslib__WEBPACK_IMPORTED_MODULE_6__.__decorate)([
...
module.exports = "nav {\n  position: relative;\n  display: flex;\n  align-items: center;\n  color: white;\n  top: 0px;\n  left: 0px;\n  width: 100%;\n  height: 60px;\n  background-color: var(--ion-color-primary);\n  border-radius: 0px 0px 15px 15px;\n}\n/*# sourceMappingURL=data:application/json;base64, */";
...
module.exports = ".card {\n  padding: 15px;\n  border-radius: 9px;\n  box-shadow: 0px 0px 10px 0px rgba(0, 0, 0, 0.2);\n  display: flex;\n  flex-direction: column;\n  justify-content: space-between;\n}\n.card .main {\n  display: flex;\n  flex-direction: row;\n}\n.card .main img {\n  width: 50px;\n  height: 50px;\n  border-radius: 50%;\n}\n.card .main .data {\n  display: flex;\n  flex-direction: column;\n  width: 100%;\n}\n.card .main .data .details {\n  display: flex;\n  flex-direction: row;\n  justify-content: space-between;\n  margin-left: 15px;\n  margin-top: 10px;\n}\n.card .main .data .details h2 {\n  font-size: 20px;\n  margin: 0;\n}\n.card .main .data .details .detail {\n  display: flex;\n  flex-direction: column;\n  justify-content: space-between;\n}\n.card .main .data .details .detail p {\n  font-size: 14px;\n  font-weight: bold;\n  margin: 0;\n}\n.card .main .data .details .detail span, .card .main .data .details .detail ion-label {\n  font-size: 12px;\n}\n.card .actions {\n  position: relative;\n  right: 0px;\n  display: flex;\n  flex-direction: row;\n  align-items: center;\n  justify-content: space-between;\n}\n.card .actions button {\n  background-color: var(--ion-color-primary);\n  color: white;\n  width: 60px;\n  border-radius: 20px;\n  height: 30px;\n  font-size: 20px;\n  margin-top: 10px;\n}\n/*# sourceMappingURL=data:application/json;base64, */";
...
module.exports = ".container {\n  background-color: #ffffff;\n  display: flex;\n  padding: 5px;\n  border-radius: 15px;\n  box-shadow: 5px 2px 10px 5px rgba(61, 68, 70, 0.164);\n}\n\n.image img {\n  min-height: 50px;\n  min-width: 50px;\n  max-width: 50px;\n  max-height: 50px;\n  margin-top: 10px;\n  border-radius: 50%;\n}\n\n.data {\n  display: flex;\n  flex-direction: column;\n  margin-top: 10px;\n  margin-left: 15px;\n}\n\n.data h2 {\n  font-size: 15px;\n  color: #6260A6;\n  margin: 0;\n}\n\n.data p {\n  font-size: 12px;\n  color: #030303;\n  margin: 5px 5px 0px 0px;\n}\n\n.icons {\n  display: flex;\n  flex-direction: column;\n  color: var(--ion-color-primary);\n  margin-left: 15px;\n  font-size: 25px;\n}\n\n.chart {\n  width: 50px;\n  margin: 5px;\n}\n/*# sourceMappingURL=data:application/json;base64, */";
...
module.exports = "* {\n  animation: fadeIn 0.3s ease-in;\n}\n\nh3 {\n  font-size: 20px;\n}\n\nh6 {\n  font-size: 18px;\n}\n\np {\n  margin: 0px;\n  margin-bottom: 5px;\n  font-size: 13px;\n  color: #181818;\n  text-align: start;\n}\n\np > span {\n  font-size: 14px;\n  color: #575757;\n  font-weight: bold;\n  margin-right: 10px;\n}\n\n.card {\n  width: 100%;\n  height: auto;\n  transition: height 0.3s ease-in;\n  background-color: #fff;\n  border-radius: 9px;\n  box-shadow: 0px 0px 10px 0px rgba(0, 0, 0, 0.1);\n  padding: 20px;\n}\n\n.card .head {\n  display: flex;\n  justify-content: space-between;\n  align-items: center;\n}\n\n.card .head .title {\n  font-size: 20px;\n  font-weight: bold;\n  color: #000;\n}\n\n.card .head .date {\n  font-size: 14px;\n  color: cornflowerblue;\n  font-weight: bold;\n}\n\n.card .data {\n  display: flex;\n  flex-direction: row;\n  justify-content: flex-start;\n  justify-content: space-between;\n}\n\ntable tr td:nth-child(1) {\n  font-weight: 600;\n  color: grey;\n  font-size: 14px;\n}\n\ntable tr td:nth-child(2) {\n  font-weight: 500;\n  color: #252525;\n  font-size: 12px;\n  padding-left: 10px;\n}\n\n.Bad {\n  color: var(--ion-color-danger);\n}\n\n.Good {\n  color: var(--ion-color-success);\n}\n\n.Average {\n  color: var(--ion-color-primary);\n}\n\n.Poor {\n  color: orange;\n}\n\n.Bad {\n  color: tomato;\n}\n\n.Excellent {\n  color: green;\n}\n\n.Unrated {\n  color: grey;\n}\n\n.card .data .ledgerService {\n  display: flex;\n  flex-direction: column;\n  align-items: flex-start;\n  width: 150px;\n  justify-content: space-between;\n  margin-left: 10px;\n}\n\n.card .data .actions {\n  display: flex;\n  flex-direction: column;\n  justify-content: space-between;\n}\n\n.card .data .actions button {\n  width: 60px;\n  height: 30px;\n  font-size: 20px;\n  border-radius: 20px;\n  color: white;\n  margin-bottom: 10px;\n  background: var(--ion-color-primary);\n}\n\n.card .divider {\n  display: flex;\n}\n\n.card .divider hr {\n  width: 100%;\n  border: 2px lightgrey solid;\n  border-radius: 5px;\n  height: 0px;\n}\n\n.card .divider button {\n  background: transparent;\n  border: none;\n  font-size: 20px;\n  color: #353535;\n}\n\n@keyframes fadeIn {\n  from {\n    transform: scale(0.9);\n    opacity: 0;\n  }\n  to {\n    transform: scale(1);\n    opacity: 1;\n  }\n}\n\n.details {\n  animation: fadeIn 0.3s ease-in;\n}\n/*# sourceMappingURL=data:application/json;base64, */";
...
module.exports = ".container {\n  font-family: \"Raleway\", sans-serif;\n  background-color: #f3f3f3;\n  display: flex;\n  justify-content: space-between;\n  padding: 10px;\n  border-radius: 20px;\n  margin-top: 10px;\n}\n\n.container img {\n  margin-top: 10px;\n  border-radius: 50%;\n  height: 50px;\n  width: 50px;\n}\n\n.heading {\n  font-size: 13px;\n  line-height: 20px;\n  margin-top: 10px;\n  color: #264A6A;\n  font-weight: bold;\n}\n\n.box {\n  display: flex;\n  justify-content: space-between;\n  margin-left: -100px;\n}\n\n.button-22 {\n  display: block;\n  height: 83px;\n  padding: 25px 5px;\n  color: #fff;\n  background-color: #6260A6;\n  border-radius: 10px;\n  margin-right: -10px;\n  margin-top: -10px;\n  margin-bottom: -10px;\n}\n/*# sourceMappingURL=data:application/json;base64, */";
...
module.exports = ".container {\n  font-family: \"Poppins\", sans-serif;\n  background-color: #f3f3f3;\n  padding: 10px;\n  border-radius: 10px;\n  box-shadow: 1px 2px 5px #9b9393;\n  margin-bottom: 15px;\n  font-weight: 500;\n}\n\n.box {\n  display: flex;\n  justify-content: space-between;\n}\n\n.box img {\n  margin-top: 10px;\n  border-radius: 50%;\n  height: 50px;\n  width: 50px;\n  box-shadow: 1px 2px 5px #9b9393;\n}\n\n.damage p {\n  font-size: 13px;\n  margin-right: -5px;\n}\n\n.code-and-price {\n  display: flex;\n  justify-content: space-between;\n  width: 135px;\n  font-size: 13px;\n  margin-top: -50px;\n  margin-left: 10px;\n}\n/*# sourceMappingURL=data:application/json;base64, */";
...
module.exports = "#card {\n  background-color: #ECF6FF;\n  padding: 2em;\n  border-radius: 30px;\n}\n\n#card-photo-and-details {\n  display: flex;\n  align-items: flex-start;\n}\n\n#card-photo {\n  width: 20%;\n  border-radius: 50%;\n  border: 3px solid #3D95E6;\n}\n\n#card-details {\n  margin-left: 1em;\n}\n\n#card-heading {\n  margin: 0;\n  margin-bottom: 0.25em;\n  font-size: 1.25rem;\n  text-transform: uppercase;\n  font-weight: 700;\n}\n\n.card-paragraph {\n  margin: 0;\n}\n\n.card-paragraph-highlight {\n  color: #3771A6;\n}\n\n#card-stepper-wrapper {\n  margin: 1.5em 0;\n  display: flex;\n  justify-content: space-between;\n}\n\n.card-stepper-item {\n  position: relative;\n  display: flex;\n  flex-direction: column;\n  align-items: center;\n  flex: 1;\n}\n\n.card-stepper-item::before {\n  position: absolute;\n  content: \"\";\n  border-bottom: 2px solid #E5E5E5;\n  width: 100%;\n  top: 10px;\n  left: -50%;\n  z-index: 2;\n}\n\n.card-stepper-item::after {\n  position: absolute;\n  content: \"\";\n  border-bottom: 2px solid #E5E5E5;\n  width: 100%;\n  top: 10px;\n  left: 50%;\n  z-index: 2;\n}\n\n.card-stepper-item .card-step-counter {\n  position: relative;\n  z-index: 5;\n  display: flex;\n  justify-content: center;\n  align-items: center;\n  width: 20px;\n  height: 20px;\n  border-radius: 50%;\n  background: #E5E5E5;\n  margin-bottom: 6px;\n}\n\n.card-stepper-item.completed .card-step-counter {\n  background-color: #3EA1FD;\n}\n\n.card-stepper-item.completed::after {\n  position: absolute;\n  content: \"\";\n  border-bottom: 2px solid #3EA1FD;\n  width: 100%;\n  top: 10px;\n  left: 50%;\n  z-index: 3;\n}\n\n.card-stepper-item:first-child::before {\n  content: none;\n}\n\n.card-stepper-item:last-child::after {\n  content: none;\n}\n\n.card-stepper-item .card-step-name {\n  color: #3EA1FD;\n  text-align: center;\n}\n\n.card-stepper-item:not(.completed) .card-step-name {\n  color: #47D8B1;\n}\n\n.card-more-detail {\n  margin: 0;\n}\n\n#card-more-details-button {\n  background: none;\n  color: #3EA1FD;\n  font-size: 1.1rem;\n  display: block;\n  margin: 0.5em auto 0 auto;\n}\n/*# sourceMappingURL=data:application/json;base64, */";
...
module.exports = "<ion-avatar (click)=\"authService.logout()\">\n  <img [src]=\"dataProvider.userData.photoURL\" />\n</ion-avatar>\n";
...
module.exports = "<div class=\"container\">\r\n  <div class=\"box\">\r\n    <img src=\"assets/UI/Images/profile.jpg\" alt=\"\">\r\n    <p style=\"font-size:15px;margin-left:-5px;\">{{Bakery}}<br><span style=\"opacity: 0.5\">{{ItemName}}</span></p>\r\n    <div class=\"damage\">\r\n      <p><span style=\"opacity: 0.5\">Safe<br></span>{{Safequantity}}</p>\r\n      <p><span style=\"opacity: 0.5\">Damage<br></span>{{Damagequantity}}</p>\r\n    </div>\r\n    <img src=\"assets/UI/Images/circle.png\" alt=\"\" style=\"border-radius:50%;height: 50px;width: 50px;box-shadow: 1px 2px 5px rgb(155, 147, 147);margin-top: 10px;\">\r\n  </div>\r\n  <div class=\"code-and-price\">\r\n    <p><span style=\"opacity: 0.5\">Code<br></span>{{Suppcode}}</p>\r\n    <p><span style=\"opacity: 0.5\">Price<br></span>{{Price}}</p>\r\n  </div>\r\n</div>\r\n";
...
module.exports = "<div id=\"card\">\r\n  <div id=\"card-photo-and-details\">\r\n      <img src=\"https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQ8XFqF5rPgYotiGkYSpe7wji541p38z7OCRw&usqp=CAU\" alt=\"NAME\" id=\"card-photo\">\r\n      <div id=\"card-details\">\r\n          <h3 id=\"card-heading\">{{ this.bakery }}</h3>\r\n          <p class=\"card-paragraph card-paragraph-highlight\">{{ this.itemName }}</p>\r\n          <p class=\"card-paragraph\"><span class=\"card-paragraph-highlight\">Supplier Code:</span> {{ this.suppCode }}</p>\r\n      </div>\r\n  </div>\r\n  <div id=\"card-stepper-wrapper\">\r\n      <div class=\"card-stepper-item completed\">\r\n          <div class=\"card-step-counter\"></div>\r\n          <div class=\"card-step-name\">1st Jan</div>\r\n      </div>\r\n      <div class=\"card-stepper-item completed\">\r\n          <div class=\"card-step-counter\"></div>\r\n          <div class=\"card-step-name\">Chennai Depo</div>\r\n      </div>\r\n      <div class=\"card-stepper-item completed\">\r\n          <div class=\"card-step-counter\"></div>\r\n          <div class=\"card-step-name\">Unloaded</div>\r\n      </div>\r\n      <div class=\"card-stepper-item\">\r\n          <div class=\"card-step-counter\"></div>\r\n          <div class=\"card-step-name\">{{ this.dueDate }}</div>\r\n          <div class=\"card-step-name\">expected delivery</div>\r\n      </div>\r\n  </div>\r\n  <div id=\"card-more-details\" *ngIf=\"this.displayMoreDetails\">\r\n      <p class=\"card-more-detail\">Dispatch Date: {{ this.dispatchDate }}</p>\r\n      <p class=\"card-more-detail\">Delivery: {{ this.delivery }}</p>\r\n      <p class=\"card-more-detail\">Expt_Delivery: {{ this.expectedDelivery }}</p>\r\n      <p class=\"card-more-detail\">Gate_Entry_Date: {{ this.gateEntryDate }}</p>\r\n      <p class=\"card-more-detail\">Gate_Entry_No: {{ this.gateEntryNo }}</p>\r\n      <p class=\"card-more-detail\">MFG_Location: {{ this.mfgLocation }}</p>\r\n      <p class=\"card-more-detail\">Product_Code: {{ this.productCode }}</p>\r\n      <p class=\"card-more-detail\">Product_Name: {{ this.productName }}</p>\r\n      <p class=\"card-more-detail\">Quantity: {{ this.quantity }}</p>\r\n      <p class=\"card-more-detail\">REC_Plant_DESC: {{ this.recPlantDesc }}</p>\r\n      <p class=\"card-more-detail\">Remarks: {{ this.remarks }}</p>\r\n      <p class=\"card-more-detail\">Supp_Plant: {{ this.suppPlant }}</p>\r\n      <p class=\"card-more-detail\">Supp_Plant_Desc: {{ this.suppPlantDesc }}</p>\r\n      <p class=\"card-more-detail\">Storage_Location: {{ this.storageLocation }}</p>\r\n      <p class=\"card-more-detail\">Trans_Name: {{ this.transName }}</p>\r\n      <p class=\"card-more-detail\">Vehicle_No: {{ this.vehicleNo }}</p>\r\n  </div>\r\n  <button id=\"card-more-details-button\" (click)=\"this.displayMoreDetails = !this.displayMoreDetails\"><ion-icon name=\"{{ this.displayMoreDetails ? 'caret-up' : 'caret-down' }}\"></ion-icon></button>\r\n</div>";
